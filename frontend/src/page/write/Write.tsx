  ...
  return (
    <>
      ...
      <button
        ...
        className={editor.isActive('strike') ? activeCss : nonActiveCss}
      >
      ...
      <button
        ...
        className={editor.isActive('heading', { level: 1 }) ? activeCss : nonActiveCss}
      >
        #
      </button>
      <button
        onClick={() => editor.chain().focus().toggleHeading({ level: 2 }).run()}
        className={editor.isActive('heading', { level: 2 }) ? activeCss : nonActiveCss}
      >
        ##
      </button>
      <button
        onClick={() => editor.chain().focus().toggleHeading({ level: 3 }).run()}
        className={editor.isActive('heading', { level: 3 }) ? activeCss : nonActiveCss}
      >
        ###
      </button>
      <button
      ...
      <button
        ...
        className={editor.isActive('textStyle', { color: '#958DF1' }) ? activeCss : nonActiveCss + 'text-[#958DF1]'}
      >
        purple
      </button>
    </>
